...
public class Step9Runner2 {

    private static final Logger logger = LoggerFactory.getLogger(Step9Runner2.class);
    ...
    public static void main(String[] args) {
        ...
        var consumer = new LoanApplicationProcess2(inputTopic, outputTopic, groupId, new DebtorsRepository() {});
